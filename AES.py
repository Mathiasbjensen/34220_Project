...
rcon = np.array([0x8d, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36, 0x6c, 0xd8, 0xab, 0x4d, 0x9a,
...
def shiftRows(state):
    ...
    #stateShifted=[]
    #stateShifted=state[:4]+state[5:8]+state[4:5]+state[10:12]+state[8:10]+state[15:]+state[12:15]
    #return stateShifted
